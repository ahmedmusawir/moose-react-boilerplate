 ...
 *
 * @param  {object} user The single user data
 *
 * @return {object}      An action object with a type of ADD_USER_SUCCESS passing the user
 */
...
/**
 * Dispatched when adding the user fails
 *
 * @param  {object} error The error
 *
 * @return {object}       An action object with a type of ADD_USER_ERROR passing the error
 */
export function userAddingError(error) {
  return {
    type: ADD_USER_ERROR,
    error,
  };
